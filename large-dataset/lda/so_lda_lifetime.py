...
current_question_group = 'lifetime'
    ...
    for num_topics in range(range_start, range_end, 1):
        ...
        with open("top_topics_" + str(num_topics) + "_" + current_question_group + ".csv", "w", newline="") as f:
            ...
            for topic_id, words in topics:
                ...
                if num == 204 and num_topics == 5:
                    with open('lifetime_5_204_questions.txt', 'w') as fd_tmp:
                        for index in topic_docs_map.get(topic_id, []):
                            fd_tmp.write(str(doc_index2id[index[0]]) + "\n")
                            fd_tmp.write(doc_text[index[0]]+"\n")
